    ...
    <section className="tom-showcase">
      ...
      <div className="tom-showcase__hero">
        ...
        <h1 className="hero-title">
          Theory of Machines <span>Repository</span>
        </h1>
        <p className="hero-copy">
          A student-built repository of mechanisms — four-bar linkages, cams, gears,
          and more — complete with drawings, videos, CAD files, and technical breakdowns.
        </p>
      </div>
